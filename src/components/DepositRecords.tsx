...
const DepositRecords = () => {
  ...
  const [depositType, setDepositType] = useState('เติมเงินแบบออฟไลน์');
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="shadow-sm border">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium text-gray-800">บันทึกการเติมเงิน - เงื่อนไขการค้นหา (*จำเป็น)</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Select value={depositType} onValueChange={setDepositType}>
              ...
              <SelectContent>
                <SelectItem value="เติมเงินแบบออฟไลน์">เติมเงินแบบออฟไลน์</SelectItem>
                <SelectItem value="เติมเงินแบบออนไลน์">เติมเงินแบบออนไลน์</SelectItem>
              </SelectContent>
            </Select>
          </div>
      ...
      <Card className="shadow-sm border">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium text-gray-800">รายการบันทึกการเติมเงิน</CardTitle>
            <ChevronUp className="h-4 w-4 text-gray-500" />
          </div>
        </CardHeader>
        <CardContent>
