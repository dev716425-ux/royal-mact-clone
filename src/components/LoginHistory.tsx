  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="shadow-sm border">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium text-gray-800">ประวัติการเข้าสู่ระบบ - เกณฑ์การค้นหา</CardTitle>
      ...
      <Card className="shadow-sm border">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium text-gray-800">บันทึกการเข้าสู่ระบบ - รายการข้อมูล</CardTitle>
